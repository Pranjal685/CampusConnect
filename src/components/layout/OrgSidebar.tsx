...
import { LayoutDashboard, ClipboardList, Users, Trophy, Settings, Zap, LogOut, ChevronRight } from "lucide-react";
...
const navItems = [
  ...
  { href: "/org/ambassadors", label: "Ambassadors", icon: Users },
  { href: "/org/leaderboard", label: "Leaderboard", icon: Trophy },
];
      ...
      <div className="p-5 border-b border-white/[0.04]">
        <Link href="/org/dashboard" className="flex items-center gap-2.5 group">
          ...
          <div>
            ...
            <span className="text-[9px] label-text">Organization</span>
          </div>
        </Link>
      </div>
      ...
      <div className="p-3 border-t border-white/[0.04]">
        <div className="flex items-center gap-2.5 px-3 py-2 mb-1">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[12px] font-medium text-white truncate">{user?.full_name || "Organization"}</p>
